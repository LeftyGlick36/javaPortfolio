 ...
 * 
 * System.out.println("myString is: " + myString); System.out.println(
 * "myInt is: " + myInt); The code above creates a Scanner object named and uses
 * it to read a String and an int. It then closes the Scanner object because
