 ...
 * parameter. Each struct Node has a data field (which stores integer data) and
 * a next field (which points to the next element in the list).
 * 
 ...
 * 
 * NULL 1->2->3->NULL and are the two head nodes passed as arguments to
 * Print(Node* head).
 * 
 * Note: In linked list diagrams, -> describes a pointer to the next node in the
 * list.
 * 
 * Sample Output
 * 
 ...
 * printed. Test Case 1: 1->2->3->NULL. This is a non-empty list so we loop
