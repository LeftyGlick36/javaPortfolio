 ...
 * has some unique index, (where ), that can be referenced as (you may also see
 * it written as ).
 * 
 ...
 * Input Format
 * 
 * The first line contains an integer, (the number of integers in ). The second
 * line contains space-separated integers describing .
 * 
 * Constraints
 * 
 * Output Format
