 ...
 * input and print the result on a new line. Note: If you are using a language
 * that doesn't support using for string concatenation (e.g.: C), you can just
 * print one variable immediately following the other on the same line. The
 * string provided in your editor must be printed first, immediately followed by
