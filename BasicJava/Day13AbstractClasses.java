...
/**
 * Objective Today, we're taking what we learned yesterday about Inheritance and
 * extending it to Abstract Classes. Because this is a very specific
 * Object-Oriented concept, submissions are limited to the few languages that
 * use this construct. Check out the Tutorial tab for learning materials and an
 * instructional video!
 * 
 ...
 * not use an access modifier (e.g.: ) when declaring MyBook or your code will
 * not execute.
 * 
 * Input Format
 * 
 ...
 * Output Format
 * 
 * The method should print and label the respective , , and of the MyBook
