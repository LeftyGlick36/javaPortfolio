...
/**
 * Objective Today, we're learning about Key-Value pair mappings using a Map or
 * Dictionary data structure. Check out the Tutorial tab for learning materials
 ...
 * 
 * Query 0: sam Sam is one of the keys in our dictionary, so we print
 * sam=99912222.
 * 
 * Query 1: edward Edward is not one of the keys in our dictionary, so we print
 * Not found.
 * 
 * Query 2: harry Harry is one of the keys in our dictionary, so we print
 * harry=12299933.
 * 
 * @author mosesmanning
 *
